...
const SCENE_PINS: Record<string, PinDef[]> = {
  ...
  castle: [
    { id: 'castle_bldg', name: '🏰 Castle Building', color: '#ffd700', xFrac: 0.390, yFrac: 0.579, wFrac: 0.400, hFrac: 0.300 },
    { id: 'castle_png',  name: '🏰 Castle.png',      color: '#ffcc44', xFrac: 0.397, yFrac: 0.149, wFrac: 0.200, hFrac: 0.200 },
    { id: 'nc_logo',     name: '⭕ Naked Castle Logo', color: '#ffdd88', xFrac: 0.440, yFrac: 0.046, wFrac: 0.118, hFrac: 0.118, hidden: true },
    { id: 'mem_castle',  name: '📼 Castle Memory',   color: '#ff8800', xFrac: 0.508, yFrac: 0.380, wFrac: 0.098, hFrac: 0.171 },
